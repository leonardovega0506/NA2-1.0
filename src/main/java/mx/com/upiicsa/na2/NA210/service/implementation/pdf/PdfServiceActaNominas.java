...
@Service
public class PdfServiceActaNominas {
    ...
    public File generatePlacesPdf(LocalDate fecha) throws Exception{
        Context context = getContextPlaceListPdf(fecha);
    ...
    private File renderPlaceListPdf(String html) throws Exception {
        File file = File.createTempFile("nominasTrabajadores", ".pdf");
    ...
    private Context getContextPlaceListPdf(LocalDate fecha) {
        List<NominaTrabajadorModel> nominaList= iNomina.findAllNominasByFecha(fecha);
        Context context = new Context();
        context.setVariable("nominas", nominaList);
        return context;
    }
    private String loadAndFillTemplate(Context context) {
        return springTemplateEngine.process("actaNominaPDF", context);
    }
