...
@Service
public class PdfServiceSolicitudVacaciones {
    ...
    private File renderPlaceListPdf(String html) throws Exception {
        File file = File.createTempFile("solicitudVacaciones", ".pdf");
    ...
    private String loadAndFillTemplate(Context context) {
        return springTemplateEngine.process("solicitudVacacionesPDF", context);
    }
}
