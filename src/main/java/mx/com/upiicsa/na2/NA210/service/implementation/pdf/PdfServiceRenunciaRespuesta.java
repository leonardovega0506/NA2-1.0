...
@Service
public class PdfServiceRenunciaRespuesta {
    ...
    public File generatePlacesPdf(Long id_renuncia) throws Exception{
        Context context = getContextPlaceListPdf(id_renuncia);
    ...
    private File renderPlaceListPdf(String html) throws Exception {
        File file = File.createTempFile("respuetaRenuncia", ".pdf");
    ...
    private String loadAndFillTemplate(Context context) {
        return springTemplateEngine.process("respuestaRenuncia", context);
    }
}
